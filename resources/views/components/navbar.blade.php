...
<nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent   ">
  <div class="container-fluid" style="display: flex; justify-content: space-between; align-items: center;">
    <div class="navbar-wrapper" style="display: flex; align-items: center; gap: 1em;">
      ...
      <a href="" class="text-light" style="display: flex; align-items: center; text-decoration: none;">
        <img src="{{ asset('assets/img/oasis.enc') }}" alt="Logo" style="width: 3em; height: auto; display: block;">
