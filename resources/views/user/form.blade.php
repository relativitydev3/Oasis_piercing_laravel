<div class="">
    ...
    <div class="form-group mb-3">
        ...
        @if($user?->imagen && file_exists(public_path('storage/' . $user->imagen)))
        <img id="imagen-preview" src="{{ asset('storage/' . $user->imagen) }}" alt="{{ $user->nombre }}" class="mt-2 img-thumbnail" style="max-width: 150px;">
        @else
